package com.sist.gujikja.company;

import java.text.DecimalFormat;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import com.sist.gujiksite.common.CommonMember;
...
/*
	public Company() {
	//	super; // super(); 은 Company 클래스의 부모 클래스인 CommonMember 클래스의 기본생성자 이다.
		System.out.println(">> Company 기본생성자 호출");
		//super();// 부모클래스의 생성자는 반드시 자식클래스의 기본생성자내에서 맨 처음에 나와야 한다!!
	}
*/
	...
	public void setName(String name) {
		// 회사명은 공백이 없는 한글 또는 영문으로만 이루어져야 하며 최소 2글자 이상 최대 6글자로만 되어져야 한다.
		...
		if(m.matches()){
			...
			System.out.println("[경고] 회사명은 공백이 없는 한글 또는 영문으로만 이루어져야하며 최소 2글자 이상 최대 6글자로만 되어져야 합니다.\n");
		}
